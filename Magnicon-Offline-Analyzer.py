...
# python globals
__version__ = '0.1' # Program version string
...
class aboutWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.te_about.setPlainText("Developers: Andrew Geckle & Alireza Panna")
...
class Ui_mainWindow(object):
    ...
    def setupUi(self, mainWindow) -> None:
        ...
        # mainWindow.resize(winSizeH, winSizeV)
        ...
        self.file_action = QAction("&Load...")
        self.file_action.setStatusTip("Load data file")
